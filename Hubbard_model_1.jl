...
##############################################################################
# μ sweep: two-stage HOTRG (pure-τ HOTRG_Y warmup, then combined x/y HOTRG),
# APBC in τ / PBC in σ via TNRKit.finalize_apbc!, following Akiyama &
# Kuramashi, arXiv:2105.00372.
##############################################################################
